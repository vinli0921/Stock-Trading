...
def get_random() -> float:
    """
        ...
        Return:
            Float: a float number(2 decimal) generated by https://www.random.org/decimal-fractions/?num=1&dec=2&col=1&format=plain&rnd=new

        Raises:
            ValueError: If the website generated number isn't a float number
            RuntimeError: If it takes too long(5) for the website to respond or if website is invalid or no wifi connection(Cannot reach the given wesite)
